    ...
    <div class="row align-items-center bg-light py-3 px-xl-5 d-none d-lg-flex">
        <div class="col-lg-4">
            <a href="" class="text-decoration-none">
                <span class="h1 text-uppercase icon_color bg-dark px-2">Multi</span>
                <span class="h1 text-uppercase text-dark secondary_nav_bar_background_color px-2 ml-n1">Shop</span>
            </a>
        </div>
            ...
            <form action="">
                <div class="input-group">
                    ...
                    <div class="input-group-append">
                        <span class="input-group-text bg-transparent icon_color">
